...
export const randomEvents: RandomEvent[] = [
  ...
  // ===== NEW RANDOM EVENTS BATCH 3 =====
  {
    id: 'locust_invasion',
    title: '🦗 غزو جراد',
    description: 'أسراب ضخمة من الجراد تجتاح المناطق الزراعية! المحاصيل تُدمر بالكامل.',
    category: 'economy',
    probability: 7,
    minTurn: 6,
    cooldown: 15,
    ...
    type: 'disaster',
    choices: [
      { id: 'aerial_spray', text: 'رش جوي مكثف بالمبيدات', effects: { treasury: -25, economy: 5, popularity: 5 }, regionEffects: [{ regionId: 'north', effects: { economy: 10 } }, { regionId: 'east', effects: { economy: 10 } }] },
      { id: 'manual_collection', text: 'حملة شعبية لجمع الجراد', effects: { treasury: -5, popularity: 10, economy: -5 }, factionEffects: [{ factionId: 'labor', supportChange: 10 }] },
      { id: 'accept_losses', text: 'قبول الخسائر وطلب مساعدات', effects: { economy: -15, diplomacy: 5, popularity: -10 } },
    ],
  },
  {
    id: 'chemical_explosion',
    title: '💥 انفجار مصنع كيماوي',
    description: 'انفجار ضخم في مصنع كيماويات! سحابة سامة تغطي المدينة والضحايا بالمئات.',
    category: 'social',
    probability: 4,
    minTurn: 8,
    cooldown: 20,
    ...
    type: 'disaster',
    choices: [
      { id: 'total_evacuation', text: 'إجلاء شامل ومعالجة التلوث', effects: { treasury: -50, popularity: 15, economy: -20 } },
      { id: 'contain_damage', text: 'احتواء الأضرار في المنطقة المحيطة', effects: { treasury: -20, popularity: -10 } },
      { id: 'international_cleanup', text: 'استدعاء فرق دولية متخصصة', effects: { treasury: -30, diplomacy: 10, popularity: 5 } },
    ],
  },
  {
    id: 'dam_collapse',
    title: '🌊 انهيار سد',
    description: 'سد ضخم ينهار ويغرق قرى بأكملها! كارثة إنسانية تلوح في الأفق.',
    category: 'social',
    probability: 3,
    minTurn: 10,
    cooldown: 25,
    ...
    type: 'disaster',
    choices: [
      { id: 'rescue_operation', text: 'عملية إنقاذ ضخمة بكل الإمكانيات', effects: { treasury: -45, popularity: 20, military: -5 }, regionEffects: [{ regionId: 'north', effects: { loyalty: 20, unrest: -10 } }] },
      { id: 'rebuild_dam', text: 'إعادة بناء السد بمعايير حديثة', effects: { treasury: -60, economy: 5, popularity: 10 } },
      { id: 'blame_engineer', text: 'محاكمة المهندسين المسؤولين', effects: { popularity: 5, economy: -5 }, factionEffects: [{ factionId: 'intellectuals', supportChange: -10 }] },
    ],
  },
  {
    id: 'wikileaks_exposure',
    title: '📄 تسريبات خطيرة',
    description: 'تسريب آلاف الوثائق السرية! أسرار الدولة والصفقات المشبوهة تُكشف للعالم.',
    category: 'social',
    probability: 5,
    minTurn: 9,
    cooldown: 20,
    ...
    type: 'political',
    choices: [
      { id: 'transparency', text: 'اعتماد الشفافية والاعتراف', effects: { popularity: 15, diplomacy: 5, military: -10 }, factionEffects: [{ factionId: 'intellectuals', supportChange: 20 }] },
      { id: 'hunt_leaker', text: 'مطاردة المسرب واعتقاله', effects: { popularity: -15, military: 10, diplomacy: -15 }, factionEffects: [{ factionId: 'military_faction', supportChange: 10 }, { factionId: 'intellectuals', supportChange: -20 }] },
      { id: 'deny_leaks', text: 'الإنكار والتشكيك في صحة الوثائق', effects: { popularity: -10, diplomacy: -10 } },
    ],
  },
  {
    id: 'solar_storm',
    title: '☀️ عاصفة شمسية',
    description: 'عاصفة شمسية قوية تعطل الأقمار الصناعية والاتصالات! البلاد في عزلة مؤقتة.',
    category: 'social',
    probability: 4,
    minTurn: 12,
    cooldown: 30,
    ...
    type: 'disaster',
    choices: [
      { id: 'backup_systems', text: 'تفعيل أنظمة الطوارئ البديلة', effects: { treasury: -15, economy: -5, military: 5 } },
      { id: 'calm_population', text: 'خطاب تطمين والانتظار', effects: { popularity: -5 } },
      { id: 'invest_protection', text: 'استثمار في حماية البنية التحتية', effects: { treasury: -30, economy: 10 }, factionEffects: [{ factionId: 'intellectuals', supportChange: 10 }] },
    ],
  },
  {
    id: 'celebrity_scandal',
    title: '🎬 فضيحة نجم مشهور',
    description: 'نجم سينمائي شهير يُتهم بجرائم ويطالب بحمايتك! الإعلام يتابع كل تفاصيل القضية.',
    category: 'social',
    probability: 8,
    minTurn: 4,
    cooldown: 15,
    ...
    type: 'social',
    choices: [
      { id: 'fair_trial', text: 'محاكمة عادلة بدون تدخل', effects: { popularity: 5, diplomacy: 5 }, factionEffects: [{ factionId: 'intellectuals', supportChange: 10 }] },
      { id: 'protect_celebrity', text: 'حماية النجم وإسقاط التهم', effects: { popularity: -15, economy: 5 } },
      { id: 'use_distraction', text: 'استغلال الفضيحة لتمرير قوانين', effects: { popularity: -5, economy: 10 } },
    ],
  },
  {
    id: 'archaeological_discovery',
    title: '🏛️ اكتشاف أثري مذهل',
    description: 'اكتشاف مدينة أثرية كاملة تحت الأرض! كنز تاريخي قد يجذب السياحة العالمية.',
    category: 'economy',
    probability: 6,
    minTurn: 7,
    cooldown: 25,
    ...
    type: 'social',
    choices: [
      { id: 'world_heritage', text: 'تسجيلها كتراث عالمي وفتحها للسياحة', effects: { diplomacy: 15, economy: 10, treasury: -15, popularity: 10 }, factionEffects: [{ factionId: 'intellectuals', supportChange: 20 }] },
      { id: 'excavate_treasure', text: 'التنقيب عن الكنوز وبيعها', effects: { treasury: 30, diplomacy: -20, popularity: -5 }, factionEffects: [{ factionId: 'intellectuals', supportChange: -20 }] },
      { id: 'military_zone', text: 'تحويل المنطقة لمنطقة عسكرية سرية', effects: { military: 10, popularity: -10, diplomacy: -10 } },
    ],
  },
  {
    id: 'currency_crisis',
    title: '💱 انهيار العملة',
    description: 'العملة المحلية تفقد 50% من قيمتها في أسبوع! الأسواق في فوضى والتجار يرفضون البيع.',
    category: 'economy',
    probability: 5,
    minTurn: 8,
    cooldown: 20,
    ...
    type: 'economic',
    choices: [
      { id: 'emergency_reserves', text: 'ضخ الاحتياطي الأجنبي لدعم العملة', effects: { treasury: -40, economy: 10, popularity: 5 } },
      { id: 'capital_controls', text: 'فرض قيود على تحويل العملات', effects: { economy: -10, popularity: -15, treasury: 10 }, factionEffects: [{ factionId: 'business', supportChange: -20 }] },
      { id: 'dollarize', text: 'ربط العملة بالدولار', effects: { economy: 5, diplomacy: -10, popularity: -5 }, factionEffects: [{ factionId: 'intellectuals', supportChange: -10 }] },
    ],
  },
  {
    id: 'football_world_cup',
    title: '⚽ فوز بكأس العالم',
    description: 'منتخبك الوطني يفوز بكأس العالم! فرحة عارمة تعم البلاد وفخر وطني.',
    category: 'social',
    probability: 3,
    minTurn: 15,
    cooldown: 40,
    ...
    type: 'social',
    choices: [
      { id: 'national_holiday', text: 'إعلان عطلة وطنية واحتفالات ضخمة', effects: { popularity: 25, treasury: -15, diplomacy: 10 } },
      { id: 'invest_sports', text: 'استثمار في البنية الرياضية', effects: { popularity: 15, treasury: -30, economy: 5 } },
      { id: 'capitalize_tourism', text: 'استغلال الفوز لجذب السياحة', effects: { popularity: 10, economy: 10, diplomacy: 15 } },
    ],
  },
];
