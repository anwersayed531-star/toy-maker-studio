  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-gradient-to-br from-primary/20 via-card to-success/20 rounded-2xl border-2 border-primary/50 p-8 max-w-md w-full text-center relative overflow-hidden"
      >
        {/* Decorative elements */}
        <div className="absolute top-0 left-0 w-32 h-32 bg-primary/10 rounded-full -translate-x-1/2 -translate-y-1/2" />
        <div className="absolute bottom-0 right-0 w-32 h-32 bg-success/10 rounded-full translate-x-1/2 translate-y-1/2" />
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="mx-auto w-24 h-24 rounded-full bg-gradient-to-br from-primary to-success flex items-center justify-center mb-6 shadow-lg shadow-primary/30">
          ...
          >
            <h2 className="text-3xl font-bold text-foreground mb-2">🎉 انتصار! 🎉</h2>
